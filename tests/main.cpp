...
int main() { 
    ...
    // Last zero 
    static_assert(fixed_string<sizeof(test_string_1)>(test_string_1).data[20] == 0, "Error implementation of fixed_string type");
    static_assert(wfixed_string<sizeof(wtest_string_1)/sizeof(wchar_t)>(wtest_string_1).data[20] == 0, "Error implementation of fixed_string type");
    
    
    static_assert(fixed_string<sizeof(test_string_1)>(test_string_1).get_data() == std::basic_string_view<char>(test_string_1), 
                            "Error implementation of fixed_string type");

    static_assert(wfixed_string<sizeof(wtest_string_1)/sizeof(wchar_t)>(wtest_string_1).get_data() == std::basic_string_view<wchar_t>(wtest_string_1), 
                            "Error implementation of fixed_string type");
